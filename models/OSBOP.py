...
DEFAULT_OUTFILE = BASE_DIR / "../outputs/solutionsOSBOP.txt"
DEFAULT_SUMMARYFILE = BASE_DIR / "../outputs/summaryOSBOP.txt"
DEFAULT_WARMSTART_DIR = BASE_DIR / "../outputs/warmstarts/OSBOP"
